...
SWIGINTERN PyObject *_wrap_CWL_set_verbosity(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CWL *arg1 = (CWL *) 0 ;
  bool arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:CWL_set_verbosity",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_CWL, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "CWL_set_verbosity" "', argument " "1"" of type '" "CWL *""'"); 
  }
  arg1 = reinterpret_cast< CWL * >(argp1);
  ecode2 = SWIG_AsVal_bool(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "CWL_set_verbosity" "', argument " "2"" of type '" "bool""'");
  } 
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"CWL_set_verbosity", _wrap_CWL_set_verbosity, METH_VARARGS, NULL},
